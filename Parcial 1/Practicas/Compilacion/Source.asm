; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27030.1 
	...
	TITLE	c:\Users\Alumno\source\repos\Project1\Project1\Source.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	??_C@_0L@EFACOAOE@Hola?5Mundo@			; `string'
EXTRN	_strlen:PROC
...
rtc$IMZ	ENDS
;	COMDAT ??_C@_0L@EFACOAOE@Hola?5Mundo@
CONST	SEGMENT
??_C@_0L@EFACOAOE@Hola?5Mundo@ DB 'Hola Mundo', 00H	; `string'
CONST	ENDS
;	COMDAT xdata$x
xdata$x	SEGMENT
...
_TEXT	SEGMENT
_main	PROC						; COMDAT
; File c:\users\alumno\source\repos\project1\project1\source.cpp
; Line 6
	push	ebp
	mov	ebp, esp
	sub	esp, 192				; 000000c0H
	...
	mov	eax, -858993460				; ccccccccH
	rep stosd
	mov	ecx, OFFSET __37DA7CE6_source@cpp
	call	@__CheckForDebuggerJustMyCode@4
; Line 9
	mov	esi, esp
	push	OFFSET ??$endl@DU?$char_traits@D@std@@@std@@YAAAV?$basic_ostream@DU?$char_traits@D@std@@@0@AAV10@@Z ; std::endl<char,std::char_traits<char> >
	push	OFFSET ??_C@_0L@EFACOAOE@Hola?5Mundo@
